...
# ==================================================
# SECTION: Background Helper Functions
# ==================================================
...
def run_test(param = None):
    ...
    second_bath_time = 600 # always 10 minutes
    ...
    if(take_picture):
        time.sleep(10) # make sure the camera has time to adjust to the lighting and everything
        url.take_snapshot()
    ...
    if(take_picture):
        time.sleep(10) # give time for camera to adjust to lighting
        url.take_snapshot()
